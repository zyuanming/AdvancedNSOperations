...
class ExclusivityController {
    ...
    func addOperation(_ operation: YMOperation, categories: [String]) {
        /*
    ...
    func removeOperation(_ operation: YMOperation, categories: [String]) {
        serialQueue.async {
            for category in categories {
    ...
    fileprivate func noqueue_addOperation(_ operation: YMOperation, category: String) {
    ...
    fileprivate func noqueue_removeOperation(_ operation: YMOperation, category: String) {
