...
protocol OperationCondition {
    ...
    */
    func dependencyForOperation(_ operation: YMOperation) -> Operation?
    
    /// Evaluate the condition, to see if it has been satisfied or not.
    func evaluateForOperation(_ operation: YMOperation, completion: @escaping (OperationConditionResult) -> Void)
}
...
struct OperationConditionEvaluator {
    static func evaluate(_ conditions: [OperationCondition], operation: YMOperation, completion: @escaping ([NSError]) -> Void) {
        // Check conditions.
